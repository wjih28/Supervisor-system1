...
class _SupervisorDashboardState extends State<SupervisorDashboard> {
          ...
          DrawerHeader(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(widget.isGuest ? 'عرض الضيف التجريبي' : 'المشرف الأكاديمي',
                    style:
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => SettingsScreen(
                  supervisor:
                      widget.isGuest ? _guestSupervisor : widget.supervisor!,
                  isGuest: widget.isGuest,
                ),
              ),
            );
  ...
  Widget _buildDrawerItem(
    ...
    return ListTile(
      ...
      selectedTileColor: const Color(0xFF2D62ED).withValues(alpha: 0.1),
      onTap: onTap,
    );
  }
